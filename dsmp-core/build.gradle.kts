...
tasks.withType<ShadowJar> {
    ...
    archiveFileName.set("DSMP-Core-${project.version}.jar")

    relocate("com.cryptomorin", "cc.dreamcode.dsmp.libs.com.cryptomorin")
    relocate("eu.okaeri", "cc.dreamcode.dsmp.libs.eu.okaeri")
    relocate("net.kyori", "cc.dreamcode.dsmp.libs.net.kyori")

    relocate("cc.dreamcode.platform", "cc.dreamcode.dsmp.libs.cc.dreamcode.platform")
    relocate("cc.dreamcode.utilities", "cc.dreamcode.dsmp.libs.cc.dreamcode.utilities")
    relocate("cc.dreamcode.menu", "cc.dreamcode.dsmp.libs.cc.dreamcode.menu")
    relocate("cc.dreamcode.command", "cc.dreamcode.dsmp.libs.cc.dreamcode.command")
    relocate("cc.dreamcode.notice", "cc.dreamcode.dsmp.libs.cc.dreamcode.notice")

    relocate("org.bson", "cc.dreamcode.dsmp.libs.org.bson")
    relocate("com.mongodb", "cc.dreamcode.dsmp.libs.com.mongodb")
    relocate("com.zaxxer", "cc.dreamcode.dsmp.libs.com.zaxxer")
    relocate("org.slf4j", "cc.dreamcode.dsmp.libs.org.slf4j")
    relocate("org.json", "cc.dreamcode.dsmp.libs.org.json")
    relocate("com.google.gson", "cc.dreamcode.dsmp.libs.com.google.gson")
